...
/*****************************************************************************
** Function name:		UARTPutch
**
** Descriptions:		Send a charactor via uart
**						
**
...
#ifdef BUFFERING_UART
		if(UART0Count != 0){
			U0IER = IER_THRE | IER_RLS;   /* Disable RBR - buffer-read "atomic" */
			c = UART0Buffer[--UART0Count];
...
**
** Descriptions:		Get a Strings via uart
**						Nemui trinomius
**
** parameters:			portNum,*char,bufsize
