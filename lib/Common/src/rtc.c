 ...
 *   2009.07.03  ver 2.00	 Nemui fixed LPC23xx.H ->LPC23xx.h
 *							   and fixed DayOfYear -> DayOfMonth! 
 *   2009.07.28  ver 3.00    FatFs Special
 *   2009.10.23  ver 4.00    branched rtc and rtc_support
*****************************************************************************/

/*-----------------------------------------
				includes
-------------------------------------------*/
#include "LPC23xx.h"     /* 20090703Nemui */ /* LPC23xx/24xx definitions */
#include "target.h"
#include "rtc.h"
