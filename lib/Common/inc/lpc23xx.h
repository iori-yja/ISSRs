 ...
 * Processor        : LPC23xx
 * Last update      :
 * Last updated by  : 20090728 nemui
 * History          : 20090728 nemui added potability 
 *
 *****************************************************************************
 *
...
/* USB Controller */
#define USB_BASE_ADRS      0xFFE0C000

/* USBPortSel only available on the LPC2378 */
#define USBPortSel         (*(volatile unsigned long *)(USB_BASE_ADRS + 0x110))

/* USB Clock Control Registers */
#define USBClkCtrl         (*(volatile unsigned long *)(USB_BASE_ADRS + 0xFF4))
#define USBClkSt           (*(volatile unsigned long *)(USB_BASE_ADRS + 0xFF8))

/* USB Device Interrupt Registers */
#define USBIntSt           (*(volatile unsigned long *)(USB_BASE_ADRS + 0x1C0))
#define USBDevIntSt        (*(volatile unsigned long *)(USB_BASE_ADRS + 0x200))
#define USBDevIntEn        (*(volatile unsigned long *)(USB_BASE_ADRS + 0x204))
#define USBDevIntClr       (*(volatile unsigned long *)(USB_BASE_ADRS + 0x208))
#define USBDevIntSet       (*(volatile unsigned long *)(USB_BASE_ADRS + 0x20C))
#define USBDevIntPri       (*(volatile unsigned long *)(USB_BASE_ADRS + 0x22C))

/* USB Device Endpoint Interrupt Registers */
#define USBEpIntSt         (*(volatile unsigned long *)(USB_BASE_ADRS + 0x230))
#define USBEpIntEn         (*(volatile unsigned long *)(USB_BASE_ADRS + 0x234))
#define USBEpIntClr        (*(volatile unsigned long *)(USB_BASE_ADRS + 0x238))
#define USBEpIntSet        (*(volatile unsigned long *)(USB_BASE_ADRS + 0x23C))
#define USBEpIntPri        (*(volatile unsigned long *)(USB_BASE_ADRS + 0x240))

/* USB Device Endpoint Realization Registers */
#define USBReEp            (*(volatile unsigned long *)(USB_BASE_ADRS + 0x244))
#define USBEpInd           (*(volatile unsigned long *)(USB_BASE_ADRS + 0x248))
#define USBMaxPSize        (*(volatile unsigned long *)(USB_BASE_ADRS + 0x24C))

/* USB Device Data Transfer Registers */
#define USBRxData          (*(volatile unsigned long *)(USB_BASE_ADRS + 0x218))
#define USBRxPLen          (*(volatile unsigned long *)(USB_BASE_ADRS + 0x220))
#define USBTxData          (*(volatile unsigned long *)(USB_BASE_ADRS + 0x21C))
#define USBTxPLen          (*(volatile unsigned long *)(USB_BASE_ADRS + 0x224))
#define USBCtrl            (*(volatile unsigned long *)(USB_BASE_ADRS + 0x228))

/* USB SIE Command Reagisters */
#define USBCmdCode         (*(volatile unsigned long *)(USB_BASE_ADRS + 0x210))
#define USBCmdData         (*(volatile unsigned long *)(USB_BASE_ADRS + 0x214))

/* USB Device DMA Registers */
#define USBDMARSt          (*(volatile unsigned long *)(USB_BASE_ADRS + 0x250))
#define USBDMARClr         (*(volatile unsigned long *)(USB_BASE_ADRS + 0x254))
#define USBDMARSet         (*(volatile unsigned long *)(USB_BASE_ADRS + 0x258))
#define USBUDCAH           (*(volatile unsigned long *)(USB_BASE_ADRS + 0x280))
#define USBEpDMASt         (*(volatile unsigned long *)(USB_BASE_ADRS + 0x284))
#define USBEpDMAEn         (*(volatile unsigned long *)(USB_BASE_ADRS + 0x288))
#define USBEpDMADis        (*(volatile unsigned long *)(USB_BASE_ADRS + 0x28C))
#define USBDMAIntSt        (*(volatile unsigned long *)(USB_BASE_ADRS + 0x290))
#define USBDMAIntEn        (*(volatile unsigned long *)(USB_BASE_ADRS + 0x294))
#define USBEoTIntSt        (*(volatile unsigned long *)(USB_BASE_ADRS + 0x2A0))
#define USBEoTIntClr       (*(volatile unsigned long *)(USB_BASE_ADRS + 0x2A4))
#define USBEoTIntSet       (*(volatile unsigned long *)(USB_BASE_ADRS + 0x2A8))
#define USBNDDRIntSt       (*(volatile unsigned long *)(USB_BASE_ADRS + 0x2AC))
#define USBNDDRIntClr      (*(volatile unsigned long *)(USB_BASE_ADRS + 0x2B0))
#define USBNDDRIntSet      (*(volatile unsigned long *)(USB_BASE_ADRS + 0x2B4))
#define USBSysErrIntSt     (*(volatile unsigned long *)(USB_BASE_ADRS + 0x2B8))
#define USBSysErrIntClr    (*(volatile unsigned long *)(USB_BASE_ADRS + 0x2BC))
#define USBSysErrIntSet    (*(volatile unsigned long *)(USB_BASE_ADRS + 0x2C0))


/* USB Controller Slight Change above this*/
